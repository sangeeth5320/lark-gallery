...
/////////////////////////////////////////////////////////////////////////
//                                                                     //
// client/lib/revolution-slider/rs-plugin/js/jquery.themepunch.tools.m //
//                                                                     //
/////////////////////////////////////////////////////////////////////////
                                                                       //
                                                                       //
  ...
  var p = "left",                                                      // 22
    ...
    var F = f(this),                                                   // 22
      ...
      if (E[G]) {                                                      // 22
        ...
        f.error("Method " + G + " does not exist on jQuery.swipe");    // 22
      }                                                                //
    } else {                                                           //
      if (!E && (typeof G === "object" || !G)) {                       // 22
        return w.apply(this, arguments);                               // 22
      }                                                                //
    }return F;                                                         //
    ...
    if (E && (E.allowPageScroll === undefined && (E.swipe !== undefined || E.swipeStatus !== undefined))) {
      E.allowPageScroll = m;                                           // 22
    }if (E.click !== undefined && E.tap === undefined) {               //
      E.tap = E.click;                                                 // 22
    }if (!E) {                                                         //
      E = {};                                                          // 22
    }E = f.extend({}, f.fn.swipe.defaults, E);return this.each(function () {
      var G = f(this);var F = G.data(B);if (!F) {                      // 22
        F = new C(this, E);G.data(B, F);                               // 22
      }                                                                //
    });                                                                //
  }function C(a4, av) {                                                //
    var az = a || d || !av.fallbackToMouseEvents,                      // 22
        ...
        N = 0;var aW = null,                                           //
        af = null;try {                                                //
      aR.bind(J, aN);aR.bind(aD, a9);                                  // 22
    } catch (ak) {                                                     //
      f.error("events not supported " + J + "," + aD + " on jQuery.swipe");
    }this.enable = function () {                                       //
      aR.bind(J, aN);aR.bind(aD, a9);return aR;                        // 22
    };this.disable = function () {                                     //
      aK();return aR;                                                  // 22
    };this.destroy = function () {                                     //
      aK();aR.data(B, null);return aR;                                 // 22
    };this.option = function (bc, bb) {                                //
      if (av[bc] !== undefined) {                                      // 22
        if (bb === undefined) {                                        // 22
          return av[bc];                                               // 22
        } else {                                                       //
          av[bc] = bb;                                                 // 22
      ...
      if (aB()) {                                                      // 22
        ...
        Z = q;O(be, Z);return bc;                                      // 22
      } else {                                                         //
        if (av.hold) {                                                 // 22
          af = setTimeout(f.proxy(function () {                        // 22
            aR.trigger("hold", [be.target]);if (av.hold) {             // 22
              bc = av.hold.call(aR, be, be.target);                    // 22
            }                                                          //
      ...
      var bh = be.originalEvent ? be.originalEvent : be;if (Z === h || Z === q || am()) {
        ...
        aP = aL(bf.start, bf.end);al(be, aP);ag = aS(bf.start, bf.end);ab = aM();aI(aP, ag);if (av.swipeStatus || av.pinchStatus) {
          ...
          var bb = true;if (av.triggerOnTouchLeave) {                  // 22
            var bg = aY(this);bb = E(bf.end, bg);                      // 22
          }if (!av.triggerOnTouchEnd && bb) {                          //
            Z = aC(k);                                                 // 22
          } else {                                                     //
            if (av.triggerOnTouchLeave && !bb) {                       // 22
              Z = aC(h);                                               // 22
            }                                                          //
          }if (Z == q || Z == h) {                                     //
            O(bh, Z);                                                  // 22
      ...
      var bc = bb.originalEvent;if (a) {                               // 22
        if (bc.touches.length > 0) {                                   // 22
          F();return true;                                             // 22
        }                                                              //
      }if (am()) {                                                     //
        W = ad;                                                        // 22
        ...
        if (av.triggerOnTouchEnd || av.triggerOnTouchEnd == false && Z === k) {
          bb.preventDefault();Z = h;O(bc, Z);                          // 22
        } else {                                                       //
          if (!av.triggerOnTouchEnd && a6()) {                         // 22
            Z = h;aF(bc, Z, A);                                        // 22
          } else {                                                     //
            if (Z === k) {                                             // 22
              Z = q;O(bc, Z);                                          // 22
      ...
      W = 0;a2 = 0;T = 0;a1 = 0;aZ = 0;G = 1;R();ao(false);            // 22
    }function K(bb) {                                                  //
      var bc = bb.originalEvent;if (av.triggerOnTouchLeave) {          // 22
        Z = aC(h);O(bc, Z);                                            // 22
      }                                                                //
    }function aK() {                                                   //
      ...
      var be = bf;var bd = aA();var bc = an();var bb = ba();if (!bd || bb) {
        ...
        if (bc && bf == k && (!av.triggerOnTouchEnd || av.triggerOnTouchLeave)) {
          ...
          if (!bc && bf == h && av.triggerOnTouchLeave) {              // 22
            be = q;                                                    // 22
          }                                                            //
        }                                                              //
      }return be;                                                      //
    }function O(bd, bb) {                                              //
      var bc = undefined;if (I() || V()) {                             // 22
        bc = aF(bd, bb, l);                                            // 22
      } else {                                                         //
        if ((P() || aX()) && bc !== false) {                           // 22
          bc = aF(bd, bb, t);                                          // 22
      ...
      var bc = undefined;if (bd == l) {                                // 22
        ...
        if (bb === q || bb === h) {                                    // 22
          clearTimeout(aW);clearTimeout(af);if (Y() && !H()) {         // 22
            N = at();aW = setTimeout(f.proxy(function () {             // 22
              N = null;aR.trigger("tap", [be.target]);if (av.tap) {    // 22
                bc = av.tap.call(aR, be, be.target);                   // 22
              }                                                        //
        ...
        if (bd == j) {                                                 // 22
          if (bb === q || bb === h) {                                  // 22
            clearTimeout(aW);N = null;aR.trigger("doubletap", [be.target]);if (av.doubleTap) {
              bc = av.doubleTap.call(aR, be, be.target);               // 22
            }                                                          //
          }                                                            //
        } else {                                                       //
          if (bd == b) {                                               // 22
            if (bb === q || bb === h) {                                // 22
              clearTimeout(aW);N = null;aR.trigger("longtap", [be.target]);if (av.longTap) {
                bc = av.longTap.call(aR, be, be.target);               // 22
              }                                                        //
            }                                                          //
          }                                                            //
        }                                                              //
      ...
      var bb = true;if (av.threshold !== null) {                       // 22
        bb = ag >= av.threshold;                                       // 22
      }return bb;                                                      //
    }function ba() {                                                   //
      var bb = false;if (av.cancelThreshold !== null && aP !== null) {
        bb = aT(aP) - ag >= av.cancelThreshold;                        // 22
      }return bb;                                                      //
    }function ae() {                                                   //
      if (av.pinchThreshold !== null) {                                // 22
        return aq >= av.pinchThreshold;                                // 22
      }return true;                                                    //
    }function aA() {                                                   //
      var bb;if (av.maxTimeThreshold) {                                // 22
        if (ab >= av.maxTimeThreshold) {                               // 22
          bb = false;                                                  // 22
        } else {                                                       //
          bb = true;                                                   // 22
        }                                                              //
      ...
      if (av.allowPageScroll === m || aX()) {                          // 22
        bb.preventDefault();                                           // 22
      } else {                                                         //
        var bd = av.allowPageScroll === s;switch (bc) {case p:         // 22
            ...
            if (av.swipeUp && bd || !bd && av.allowPageScroll != u) {  // 22
              bb.preventDefault();                                     // 22
            }break;case x:                                             //
      ...
      var bc = aO();var bb = X();var bd = ae();return bc && bb && bd;  // 22
    }function aX() {                                                   //
      return !!(av.pinchStatus || av.pinchIn || av.pinchOut);          // 22
    }function P() {                                                    //
      return !!(a8() && aX());                                         // 22
    }function aV() {                                                   //
      ...
      return W === av.fingers || av.fingers === i || !a;               // 22
    }function X() {                                                    //
      return aQ[0].end.x !== 0;                                        // 22
    }function a6() {                                                   //
      return !!av.tap;                                                 // 22
    }function Y() {                                                    //
      return !!av.doubleTap;                                           // 22
    }function aU() {                                                   //
      return !!av.longTap;                                             // 22
    }function Q() {                                                    //
      if (N == null) {                                                 // 22
        return false;                                                  // 22
      ...
      return (W === 1 || !a) && (isNaN(ag) || ag < av.threshold);      // 22
    }function a0() {                                                   //
      return ab > av.longTapThreshold && ag < r;                       // 22
    }function ah() {                                                   //
      return !!(ax() && a6());                                         // 22
    }function aG() {                                                   //
      return !!(Q() && Y());                                           // 22
      ...
      a5 = at();ad = event.touches.length + 1;                         // 22
    }function R() {                                                    //
      a5 = 0;ad = 0;                                                   // 22
    }function am() {                                                   //
      var bb = false;if (a5) {                                         // 22
        var bc = at() - a5;if (bc <= av.fingerReleaseThreshold) {      // 22
          bb = true;                                                   // 22
        }                                                              //
      }return bb;                                                      //
    }function aB() {                                                   //
      return !!(aR.data(B + "_intouch") === true);                     // 22
    }function ao(bb) {                                                 //
      if (bb === true) {                                               // 22
        aR.bind(ay, a3);aR.bind(U, L);if (S) {                         // 22
          aR.bind(S, K);                                               // 22
        }                                                              //
      } else {                                                         //
        aR.unbind(ay, a3, false);aR.unbind(U, L, false);if (S) {       // 22
          aR.unbind(S, K, false);                                      // 22
        }                                                              //
      ...
      for (var bb = 0; bb < aQ.length; bb++) {                         // 22
        if (aQ[bb].identifier == bc) {                                 // 22
          return aQ[bb];                                               // 22
        }                                                              //
      }                                                                //
    }function aj() {                                                   //
      var bb = [];for (var bc = 0; bc <= 5; bc++) {                    // 22
        bb.push({ start: { x: 0, y: 0 }, end: { x: 0, y: 0 }, identifier: 0 });
      }return bb;                                                      //
    }function aI(bb, bc) {                                             //
      bc = Math.max(bc, aT(bb));M[bb].distance = bc;                   // 22
    }function aT(bb) {                                                 //
      if (M[bb]) {                                                     // 22
        return M[bb].distance;                                         // 22
      }return undefined;                                               //
    }function aa() {                                                   //
      var bb = {};bb[p] = aw(p);bb[o] = aw(o);bb[e] = aw(e);bb[x] = aw(x);return bb;
    }function aw(bb) {                                                 //
      return { direction: bb, distance: 0 };                           // 22
    }function aM() {                                                   //
      return a2 - T;                                                   // 22
    }function au(be, bd) {                                             //
      var bc = Math.abs(be.x - bd.x);var bb = Math.abs(be.y - bd.y);return Math.round(Math.sqrt(bc * bc + bb * bb));
    }function a7(bb, bc) {                                             //
      var bd = bc / bb * 1;return bd.toFixed(2);                       // 22
    }function ar() {                                                   //
      if (G < 1) {                                                     // 22
        return z;                                                      // 22
      } else {                                                         //
      ...
      var bb = be.x - bc.x;var bg = bc.y - be.y;var bd = Math.atan2(bg, bb);var bf = Math.round(bd * 180 / Math.PI);if (bf < 0) {
        bf = 360 - Math.abs(bf);                                       // 22
      }return bf;                                                      //
    }function aL(bc, bb) {                                             //
      var bd = aE(bc, bb);if (bd <= 45 && bd >= 0) {                   // 22
        return p;                                                      // 22
      } else {                                                         //
        if (bd <= 360 && bd >= 315) {                                  // 22
          return p;                                                    // 22
      ...
      var bb = new Date();return bb.getTime();                         // 22
    }function aY(bb) {                                                 //
      ...
      return bb.x > bc.left && bb.x < bc.right && bb.y > bc.top && bb.y < bc.bottom;
                                                                       ...
                                                                       //
if (typeof console === 'undefined') {                                  // 26
  var console = {};                                                    // 27
  console.log = console.error = console.info = console.debug = console.warn = console.trace = console.dir = console.dirxml = console.group = console.groupEnd = console.time = console.timeEnd = console.assert = console.profile = console.groupCollapsed = function () {};
}                                                                      //
                                                                       //
if (window.tplogs == true) try {                                       // 31
  console.groupCollapsed("ThemePunch GreenSocks Logs");                // 33
} catch (e) {}                                                         //
                                                                       //
var oldgs = window.GreenSockGlobals;                                   // 37
oldgs_queue = window._gsQueue;                                         // 38
                                                                       //
var punchgs = window.GreenSockGlobals = {};                            // 40
                                                                       //
if (window.tplogs == true) try {                                       // 42
  console.info("Build GreenSock SandBox for ThemePunch Plugins");      // 44
  ...
  "use strict";var i = t.GreenSockGlobals = t.GreenSockGlobals || t;if (!i.TweenLite) {
    var s,                                                             // 59
      ...
      var e,                                                           // 59
        ...
        m = function () {},                                            //
        f = (function () {                                             //
      var t = Object.prototype.toString,                               // 59
      ...
      this.sc = c[s] ? c[s].sc : [], c[s] = this, this.gsClass = null, this.func = n;var o = [];this.check = function (h) {
        for (var _, u, m, f, d = r.length, v = d; --d > -1;) (_ = c[r[d]] || new p(r[d], [])).gsClass ? (o[d] = _.gsClass, v--) : h && _.sc.push(this);if (0 === v && n) for (u = ("com.greensock." + s).split("."), m = u.pop(), f = l(u.join("."))[m] = this.gsClass = n.apply(n, o), a && (i[m] = f, "function" == typeof define && define.amd ? define((t.GreenSockAMDPath ? t.GreenSockAMDPath + "/" : "") + s.split(".").pop(), [], function () {
          return f;                                                    // 59
        }) : s === e && "undefined" != typeof module && module.exports && (module.exports = f)), d = 0; this.sc.length > d; d++) this.sc[d].check();
      }, this.check(!0);                                               //
    },                                                                 //
        d = t._gsDefine = function (t, e, i, s) {                      //
      return new p(t, e, i, s);                                        // 59
    },                                                                 //
        v = h._class = function (t, e, i) {                            //
      return (e = e || function () {}, d(t, [], function () {          // 59
        return e;                                                      // 59
      }, i), e);                                                       //
      ...
      this._listeners = {}, this._eventTarget = t || this;             // 59
      ...
      o && S() - x > 2e3 && a.wake(), setTimeout(C, 2e3);              // 59
    };C(), n.play = function (t, e) {                                  //
      return (null != t && this.seek(t, e), this.reversed(!1).paused(!1));
    }, n.pause = function (t, e) {                                     //
      return (null != t && this.seek(t, e), this.paused(!0));          // 59
    }, n.resume = function (t, e) {                                    //
      return (null != t && this.seek(t, e), this.paused(!1));          // 59
    }, n.seek = function (t, e) {                                      //
      return this.totalTime(Number(t), e !== !1);                      // 59
      ...
      return this._enabled(!1, !1);                                    // 59
    }, n.kill = function (t, e) {                                      //
      return (this._kill(t, e), this);                                 // 59
      ...
      if (!arguments.length) return this._paused;if (t != this._paused && this._timeline) {
        o || t || a.wake();var e = this._timeline,                     // 59
            i = e.rawTime(),                                           //
      ...
      return (o || a.wake(), this._totalTime);                         // 59
      ...
      return e && e.length && e !== t && e[0] && (e[0] === t || e[0].nodeType && e[0].style && !e.nodeType);
        ...
        O = function (t, e) {                                          //
      var i,                                                           // 59
          s = {};for (i in babelHelpers.sanitizeForInObject(t)) G[i] || i in e && "transform" !== i && "x" !== i && "y" !== i && "width" !== i && "height" !== i && "className" !== i && "border" !== i || !(!U[i] || U[i] && U[i]._autoCSS) || (s[i] = t[i], delete t[i]);t.css = s;
      ...
      var t,                                                           // 59
          e = z.length;for (L = {}; --e > -1;) t = z[e], t && t._lazy !== !1 && (t.render(t._lazy[0], t._lazy[1], !0), t._lazy = !1);z.length = 0;
      ...
      var t, e, i;if ((z.length && M(), B.render((a.time - B._startTime) * B._timeScale, !1, !1), q.render((a.frame - q._startTime) * q._timeScale, !1, !1), z.length && M(), !(a.frame % 120))) {
        for (i in babelHelpers.sanitizeForInObject(F)) {               // 59
          for (e = F[i].tweens, t = e.length; --t > -1;) e[t]._gc && e.splice(t, 1);0 === e.length && delete F[i];
        }if ((i = B._first, (!i || i._paused) && I.autoSleep && !q._first && 1 === a._listeners.tick.length)) {
          for (; i && i._paused;) i = i._next;i || a.sleep();          // 59
        }                                                              //
      }                                                                //
    }, a.addEventListener("tick", R._updateRoot);var $ = function (t, e, i) {
      var s,                                                           // 59
          r,                                                           //
          n = t._gsTweenID;if ((F[n || (t._gsTweenID = n = "t" + j++)] || (F[n] = { target: t, tweens: [] }), e && (s = F[n].tweens, s[r = s.length] = e, i))) for (; --r > -1;) s[r] === e && s.splice(r, 1);return F[n].tweens;
    },                                                                 //
        K = function (t, e, i, s) {                                    //
      var r,                                                           // 59
          n,                                                           //
      ...
      var n, a, o, l;if (1 === s || s >= 4) {                          // 59
        for (l = r.length, n = 0; l > n; n++) if ((o = r[n]) !== e) o._gc || K(o, e) && o._enabled(!1, !1) && (a = !0);else if (5 === s) break;return a;
      }var h,                                                          //
          u = e._startTime + _,                                        //
          m = [],                                                      //
          f = 0,                                                       //
          c = 0 === e._duration;for (n = r.length; --n > -1;) (o = r[n]) === e || o._gc || o._paused || (o._timeline !== e._timeline ? (h = h || J(e, 0, c), 0 === J(o, h, c) && (m[f++] = o)) : u >= o._startTime && o._startTime + o.totalDuration() / o._timeScale > u && ((c || !o._initted) && 2e-10 >= u - o._startTime || (m[f++] = o)));for (n = f; --n > -1;) if ((o = m[n], 2 === s && o._kill(i, t, e) && (a = !0), 2 !== s || !o._firstPT && o._initted)) {
      ...
      var t,                                                           // 59
        ...
        this._startAt && (this._startAt.render(-1, !0), this._startAt.kill()), r = {};for (s in babelHelpers.sanitizeForInObject(n.startAt)) r[s] = n.startAt[s];if ((r.overwrite = !1, r.immediateRender = !0, r.lazy = l && n.lazy !== !1, r.startAt = r.delay = null, this._startAt = I.to(this.target, 0, r), l)) if (this._time > 0) this._startAt = null;else if (0 !== o) return;
      } else if (n.runBackwards && 0 !== o) if (this._startAt) this._startAt.render(-1, !0), this._startAt.kill(), this._startAt = null;else {
        0 !== this._time && (l = !1), i = {};for (s in babelHelpers.sanitizeForInObject(n)) G[s] && "autoCSS" !== s || (i[s] = n[s]);if ((i.overwrite = 0, i.data = "isFromStart", i.lazy = l && n.lazy !== !1, i.immediateRender = l, this._startAt = I.to(this.target, 0, i), l)) {
          if (0 === this._time) return;                                // 59
      ...
      var n, a, o, l, h, _;if (null == e) return !1;L[e._gsTweenID] && M(), this.vars.css || e.style && e !== t && e.nodeType && U.css && this.vars.autoCSS !== !1 && O(this.vars, e);for (n in babelHelpers.sanitizeForInObject(this.vars)) {
        if ((_ = this.vars[n], G[n])) _ && (_ instanceof Array || _.push && f(_)) && -1 !== _.join("").indexOf("{self}") && (this.vars[n] = _ = this._swapSelfInParams(_, this));else if (U[n] && (l = new U[n]())._onInitTween(e, this.vars[n], this)) {
          for (this._firstPT = h = { _next: this._firstPT, t: l, p: "setRatio", s: 0, c: 1, f: !0, n: n, pg: !0, pr: l._priority }, a = l._overwriteProps.length; --a > -1;) i[l._overwriteProps[a]] = this._firstPT;(l._priority || l._onInitAllProps) && (o = !0), (l._onDisable || l._onEnable) && (this._notifyPluginsOfEnabled = !0);
      ...
      if (("all" === t && (t = null), null == t && (null == e || e === this.target))) return (this._lazy = !1, this._enabled(!1, !1));e = "string" != typeof e ? e || this._targets || this.target : I.selector(e) || e;var s, r, n, a, o, l, h, _, u;if ((f(e) || E(e)) && "number" != typeof e[0]) for (s = e.length; --s > -1;) this._kill(t, e[s]) && (l = !0);else {
        if (this._targets) {                                           // 59
          ...
          if ((h = t || o, _ = t !== r && "all" !== r && t !== o && ("object" != typeof t || !t._tempKill), i && (I.onOverwrite || this.vars.onOverwrite))) {
            for (n in babelHelpers.sanitizeForInObject(h)) o[n] && (u || (u = []), u.push(n));if (!K(this, i, e, u)) return !1;
          }for (n in babelHelpers.sanitizeForInObject(h)) (a = o[n]) && (a.pg && a.t._kill(h) && (l = !0), a.pg && 0 !== a.t._overwriteProps.length || (a._prev ? a._prev._next = a._next : a === this._firstPT && (this._firstPT = a._next), a._next && (a._next._prev = a._prev), a._next = a._prev = null), delete o[n]), _ && (r[n] = 1);!this._firstPT && this._initted && this._enabled(!1, !1);
        }                                                              //
      }return l;                                                       //
    }, n.invalidate = function () {                                    //
      return (this._notifyPluginsOfEnabled && I._onPluginEvent("_onDisable", this), this._firstPT = this._overwrittenProps = this._startAt = this._onUpdate = null, this._notifyPluginsOfEnabled = this._active = this._lazy = !1, this._propLookup = this._targets ? {} : [], R.prototype.invalidate.call(this), this.vars.immediateRender && (this._time = -_, this.render(-this._delay)), this);
    }, n._enabled = function (t, e) {                                  //
      if ((o || a.wake(), t && this._gc)) {                            // 59
        var i,                                                         // 59
      ...
      for (var e = t.length; --e > -1;) t[e].API === V.API && (U[new t[e]()._propName] = t[e]);return !0;
    }, d.plugin = function (t) {                                       //
      if (!(t && t.propName && t.init && t.API)) throw "illegal plugin definition.";var e,
        ...
        V.call(this, i, s), this._overwriteProps = r || [];            // 59
      }, t.global === !0),                                             //
          o = a.prototype = new V(i);o.constructor = a, a.API = t.API;for (e in babelHelpers.sanitizeForInObject(n)) "function" == typeof t[e] && (o[n[e]] = t[e]);return (a.version = t.version, V.activate([a]), a);
    }, s = t._gsQueue)) {                                              //
      for (r = 0; s.length > r; r++) s[r]();for (n in babelHelpers.sanitizeForInObject(c)) c[n].func || t.console.log("GSAP encountered missing dependency: com.greensock." + n);
    }o = !1;                                                           //
  }                                                                    //
...
var _gsScope = "undefined" != typeof module && module.exports && "undefined" != typeof global ? global : this || window;(_gsScope._gsQueue || (_gsScope._gsQueue = [])).push(function () {
  "use strict";_gsScope._gsDefine("TimelineLite", ["core.Animation", "core.SimpleTimeline", "TweenLite"], function (t, e, i) {
    var s = function (t) {                                             // 72
      e.call(this, t), this._labels = {}, this.autoRemoveChildren = this.vars.autoRemoveChildren === !0, this.smoothChildTiming = this.vars.smoothChildTiming === !0, this._sortChildren = !0, this._onUpdate = this.vars.onUpdate;var i,
          s,                                                           //
          r = this.vars;for (s in babelHelpers.sanitizeForInObject(r)) i = r[s], o(i) && -1 !== i.join("").indexOf("{self}") && (r[s] = this._swapSelfInParams(i));o(r.tweens) && this.add(r.tweens, 0, r.align, r.stagger);
    },                                                                 //
        r = 1e-10,                                                     //
        n = i._internals,                                              //
        a = n.isSelector,                                              //
        ...
        c = function (t) {                                             //
      var e,                                                           // 72
          i = {};for (e in babelHelpers.sanitizeForInObject(t)) i[e] = t[e];return i;
    },                                                                 //
        p = function (t, e, i, s) {                                    //
      ...
      var u,                                                           // 72
          p = new s({ onComplete: h, onCompleteParams: l, onCompleteScope: _, smoothChildTiming: this.smoothChildTiming });for ("string" == typeof t && (t = i.selector(t) || t), t = t || [], a(t) && (t = f(t)), n = n || 0, 0 > n && (t = f(t), t.reverse(), n *= -1), u = 0; t.length > u; u++) r.startAt && (r.startAt = c(r.startAt)), p.to(t[u], e, c(r), u * n);return this.add(p, o);
    }, m.staggerFrom = function (t, e, i, s, r, n, a, o) {             //
      return (i.immediateRender = 0 != i.immediateRender, i.runBackwards = !0, this.staggerTo(t, e, i, s, r, n, a, o));
    }, m.staggerFromTo = function (t, e, i, s, r, n, a, o, h) {        //
      return (s.startAt = i, s.immediateRender = 0 != s.immediateRender && 0 != i.immediateRender, this.staggerTo(t, e, s, r, n, a, o, h));
    }, m.call = function (t, e, s, r) {                                //
      return this.add(i.delayedCall(0, t, e, s), r);                   // 72
      ...
      var l, _, u, c, p, f;if (("number" != typeof n && (n = this._parseTimeOrLabel(n, 0, !0, r)), !(r instanceof t))) {
        if (r instanceof Array || r && r.push && o(r)) {               // 72
          for (a = a || "normal", h = h || 0, l = n, _ = r.length, u = 0; _ > u; u++) o(c = r[u]) && (c = new s({ tweens: c })), this.add(c, l), "string" != typeof c && "function" != typeof c && ("sequence" === a ? l = c._startTime + c.totalDuration() / c._timeScale : "start" === a && (c._startTime -= c.delay())), l += h;return this._uncache(!0);
      ...
      }if ((e.prototype.add.call(this, r, n), (this._gc || this._time === this._duration) && !this._paused && this._duration < this.duration())) for (p = this, f = p.rawTime() > r._startTime; p._timeline;) f && p._timeline.smoothChildTiming ? p.totalTime(p._totalTime, !0) : p._gc && p._enabled(!0, !1), p = p._timeline;return this;
    }, m.remove = function (e) {                                       //
      if (e instanceof t) return this._remove(e, !1);if (e instanceof Array || e && e.push && o(e)) {
        for (var i = e.length; --i > -1;) this.remove(e[i]);return this;
      ...
      return this.add(t, this._parseTimeOrLabel(null, e, !0, t));      // 72
    }, m.insert = m.insertMultiple = function (t, e, i, s) {           //
      return this.add(t, e || 0, i, s);                                // 72
    }, m.appendMultiple = function (t, e, i, s) {                      //
      return this.add(t, this._parseTimeOrLabel(null, e, !0, t), i, s);
    }, m.addLabel = function (t, e) {                                  //
      return (this._labels[t] = this._parseTimeOrLabel(e), this);      // 72
    }, m.addPause = function (t, e, i, s) {                            //
      return this.call(p, ["{self}", e, i, s], this, t);               // 72
    }, m.removeLabel = function (t) {                                  //
      return (delete this._labels[t], this);                           // 72
    }, m.getLabelTime = function (t) {                                 //
      return null != this._labels[t] ? this._labels[t] : -1;           // 72
    }, m._parseTimeOrLabel = function (e, i, s, r) {                   //
      var n;if (r instanceof t && r.timeline === this) this.remove(r);else if (r && (r instanceof Array || r.push && o(r))) for (n = r.length; --n > -1;) r[n] instanceof t && r[n].timeline === this && this.remove(r[n]);if ("string" == typeof i) return this._parseTimeOrLabel(i, s && "number" == typeof e && null == this._labels[i] ? e - this.duration() : 0, s);if ((i = i || 0, "string" != typeof e || !isNaN(e) && null == this._labels[e])) null == e && (e = this.duration());else {
      ...
      return this.paused(!0);                                          // 72
    }, m.gotoAndPlay = function (t, e) {                               //
      return this.play(t, e);                                          // 72
    }, m.gotoAndStop = function (t, e) {                               //
      return this.pause(t, e);                                         // 72
    }, m.render = function (t, e, i) {                                 //
      this._gc && this._enabled(!0, !1);var s,                         // 72
          n,                                                           //
          a,                                                           //
          o,                                                           //
          u,                                                           //
      ...
      return this._recent;                                             // 72
    }, m._contains = function (t) {                                    //
      for (var e = t.timeline; e;) {                                   // 72
        if (e === this) return !0;e = e.timeline;                      // 72
      }return !1;                                                      //
    }, m.shiftChildren = function (t, e, i) {                          //
      i = i || 0;for (var s, r = this._first, n = this._labels; r;) r._startTime >= i && (r._startTime += t), r = r._next;if (e) for (s in babelHelpers.sanitizeForInObject(n)) n[s] >= i && (n[s] += t);return this._uncache(!0);
      ...
      var e = this.getChildren(!1, !0, !0),                            // 72
  ...
  "use strict";var e = function () {                                   // 72
    return (_gsScope.GreenSockGlobals || _gsScope)[t];                 // 72
...
var _gsScope = "undefined" != typeof module && module.exports && "undefined" != typeof global ? global : this || window;(_gsScope._gsQueue || (_gsScope._gsQueue = [])).push(function () {
  "use strict";_gsScope._gsDefine("easing.Back", ["easing.Ease"], function (t) {
    var e,                                                             // 85
        ...
        h = n._class,                                                  //
        l = function (e, i) {                                          //
      var s = h("easing." + e, function () {}, !0),                    // 85
      ...
      this.t = t, this.v = e, i && (this.next = i, i.prev = this, this.c = i.v - e, this.gap = i.t - t);
        ...
        p = function (e, i) {                                          //
      var s = h("easing." + e, function (t) {                          // 85
      ...
      return (t -= 1) * t * ((this._p1 + 1) * t + this._p1) + 1;       // 85
    }), p("BackIn", function (t) {                                     //
      return t * t * ((this._p1 + 1) * t - this._p1);                  // 85
      ...
      return new m(t, e, i);                                           // 85
    }, e = h("easing.SteppedEase", function (t) {                      //
      t = t || 1, this._p1 = 1 / t, this._p2 = t + 1;                  // 85
      ...
      var e = this._prev;if (t > e.t) {                                // 85
        for (; e.next && t >= e.t;) e = e.next;e = e.prev;             // 85
      ...
      return Math.sqrt(1 - (t -= 1) * t);                              // 85
    }), l("CircIn", function (t) {                                     //
      return -(Math.sqrt(1 - t * t) - 1);                              // 85
    }), l("CircInOut", function (t) {                                  //
      return 1 > (t *= 2) ? -.5 * (Math.sqrt(1 - t * t) - 1) : .5 * (Math.sqrt(1 - (t -= 2) * t) + 1);
    })), s = function (e, i, s) {                                      //
      var r = h("easing." + e, function (t, e) {                       // 85
      ...
      return 1 - Math.pow(2, -10 * t);                                 // 85
    }), l("ExpoIn", function (t) {                                     //
      return Math.pow(2, 10 * (t - 1)) - .001;                         // 85
    }), l("ExpoInOut", function (t) {                                  //
      return 1 > (t *= 2) ? .5 * Math.pow(2, 10 * (t - 1)) : .5 * (2 - Math.pow(2, -10 * (t - 1)));
    })), u("Sine", l("SineOut", function (t) {                         //
      return Math.sin(t * o);                                          // 85
    }), l("SineIn", function (t) {                                     //
      return -Math.cos(t * o) + 1;                                     // 85
    }), l("SineInOut", function (t) {                                  //
      return -.5 * (Math.cos(Math.PI * t) - 1);                        // 85
  ...
  "use strict";_gsScope._gsDefine("plugins.CSSPlugin", ["plugins.TweenPlugin", "TweenLite"], function (t, e) {
    var i,                                                             // 98
      ...
      return x.test("string" == typeof t ? t : (t.currentStyle ? t.currentStyle.filter : t.style.filter) || "") ? parseFloat(RegExp.$1) / 100 : 1;
        ...
        U = function (t) {                                             //
      window.console && console.log(t);                                // 98
    },                                                                 //
        j = "",                                                        //
        W = "",                                                        //
        V = function (t, e) {                                          //
      ...
      var i,                                                           // 98
          r,                                                           //
          s = {};if (e = e || q(t, null)) if (i = e.length) for (; --i > -1;) s[e[i].replace(S, C)] = e.getPropertyValue(e[i]);else for (i in babelHelpers.sanitizeForInObject(e)) s[i] = e[i];else if (e = t.currentStyle || t.style) for (i in babelHelpers.sanitizeForInObject(e)) "string" == typeof i && void 0 === s[i] && (s[i.replace(S, C)] = e[i]);return (Y || (s.opacity = B(t)), r = Ae(t, e, !1), s.rotation = r.rotation, s.skewX = r.skewX, s.scaleX = r.scaleX, s.scaleY = r.scaleY, s.x = r.x, s.y = r.y, be && (s.z = r.z, s.rotationX = r.rotationX, s.rotationY = r.rotationY, s.scaleZ = r.scaleZ), s.filters && delete s.filters, s);
    },                                                                 //
        $ = function (t, e, i, r, s) {                                 //
      var n,                                                           // 98
          a,                                                           //
          o,                                                           //
          l = {},                                                      //
          h = t.style;for (a in babelHelpers.sanitizeForInObject(i)) "cssText" !== a && "length" !== a && isNaN(a) && (e[a] !== (n = i[a]) || s && s[a]) && -1 === a.indexOf("Origin") && ("number" == typeof n || "string" == typeof n) && (l[a] = "auto" !== n || "left" !== a && "top" !== a ? "" !== n && "auto" !== n && "none" !== n || "string" != typeof e[a] || "" === e[a].replace(v, "") ? n : 0 : Q(t, a), void 0 !== h[a] && (o = new fe(h, a, h[a], o)));if (r) for (a in babelHelpers.sanitizeForInObject(r)) "className" !== a && (l[a] = r[a]);return { difs: l, firstMPT: o };
    },                                                                 //
      ...
      var e, i, r, s, n, a;return t && "" !== t ? "number" == typeof t ? [t >> 16, 255 & t >> 8, 255 & t] : ("," === t.charAt(t.length - 1) && (t = t.substr(0, t.length - 1)), ne[t] ? ne[t] : "#" === t.charAt(0) ? (4 === t.length && (e = t.charAt(1), i = t.charAt(2), r = t.charAt(3), t = "#" + e + e + i + i + r + r), t = parseInt(t.substr(1), 16), [t >> 16, 255 & t >> 8, 255 & t]) : "hsl" === t.substr(0, 3) ? (t = t.match(d), s = Number(t[0]) % 360 / 360, n = Number(t[1]) / 100, a = Number(t[2]) / 100, i = .5 >= a ? a * (n + 1) : a + n - a * n, e = 2 * a - i, t.length > 3 && (t[3] = Number(t[3])), t[0] = ae(s + 1 / 3, e, i), t[1] = ae(s, e, i), t[2] = ae(s - 1 / 3, e, i), t) : (t = t.match(d) || ne.transparent, t[0] = Number(t[0]), t[1] = Number(t[1]), t[2] = Number(t[2]), t.length > 3 && (t[3] = Number(t[3])), t)) : ne.black;
        ...
        le = "(?:\\b(?:(?:rgb|rgba|hsl|hsla)\\(.+?\\))|\\B#.+?\\b";for (l in babelHelpers.sanitizeForInObject(ne)) le += "|" + l + "\\b";le = RegExp(le + ")", "gi");var he = function (t, e, i, r) {
      if (null == t) return function (t) {                             // 98
        return t;                                                      // 98
      };var s,                                                         //
          n = e ? (t.match(le) || [""])[0] : "",                       //
        ...
        var e, p, _, c;if ("number" == typeof t) t += f;else if (r && D.test(t)) {
          for (c = t.replace(D, "|").split("|"), _ = 0; c.length > _; _++) c[_] = s(c[_]);return c.join(",");
        }if ((e = (t.match(le) || [n])[0], p = t.split(e).join("").match(g) || [], _ = p.length, u > _--)) for (; u > ++_;) p[_] = i ? p[0 | (_ - 1) / 2] : a[_];return o + p.join(h) + h + e + l + (-1 !== t.indexOf("inset") ? " inset" : "");
      } : function (t) {                                               //
        var e, n, p;if ("number" == typeof t) t += f;else if (r && D.test(t)) {
          for (n = t.replace(D, "|").split("|"), p = 0; n.length > p; p++) n[p] = s(n[p]);return n.join(",");
        }if ((e = t.match(g) || [], p = e.length, u > p--)) for (; u > ++p;) e[p] = i ? e[0 | (p - 1) / 2] : a[p];return o + e.join(h) + l;
      } : function (t) {                                               //
        return t;                                                      // 98
      };                                                               //
    },                                                                 //
        ue = function (t) {                                            //
      return (t = t.split(","), function (e, i, r, s, n, a, o) {       // 98
        var l,                                                         // 98
      ...
      var a,                                                           // 98
        ...
        if (1 >= r.type && (o = r.p, _[o] = r.s + r.c, p[o] = r.s, n || (h = new fe(r, "s", o, h, r.r), r.c = 0), 1 === r.type)) for (a = r.l; --a > 0;) l = "xn" + a, o = r.p + "_" + l, _[o] = r.data[l], p[o] = r[l], n || (h = new fe(r, l, o, h, r.rxp[l]));r = r._next;
      ...
      i = i || n || "", a = new pe(t, e, 0, 0, a, u ? 2 : 1, null, !1, o, i, r), r += "";var f,
        ...
        if ((y = g.match(m), !y || y.length !== v.length)) return a;for (_ = 0, p = 0; v.length > p; p++) P = v[p], w = c.indexOf(P, _), a.appendXtra(c.substr(_, w - _), Number(P), ie(y[p], P), "", O && "px" === c.substr(w + P.length, 2), 0 === p), _ = w + P.length;a["xs" + a.l] += c.substr(_);
      } else a["xs" + a.l] += a.l ? " " + c : c;if (-1 !== r.indexOf("=") && a.data) {
        for (S = a.xs0 + a.data.s, f = 1; a.l > f; f++) S += a["xs" + f] + a.data["xn" + f];a.e = S + a["xs" + f];
      }return (a.l || (a.type = -1, a.xs0 = a.e), a.xfirst || a);      //
    },                                                                 //
        ce = 9;for (l = pe.prototype, l.l = l.pr = 0; --ce > 0;) l["xn" + ce] = 0, l["xs" + ce] = "";l.xs0 = "", l._next = l._prev = l.xfirst = l.data = l.plugin = l.setRatio = l.rxp = null, l.appendXtra = function (t, e, i, r, s, n) {
      var a = this,                                                    // 98
      ...
      "object" != typeof e && (e = { parser: i });var r,               // 98
          s,                                                           //
          n = t.split(","),                                            //
        ...
        ge = function (t) {                                            //
      if (!o[t]) {                                                     // 98
        var e = t.charAt(0).toUpperCase() + t.substr(1) + "Plugin";me(t, { parser: function (t, i, r, s, n, a, l) {
      ...
      var a,                                                           // 98
        ...
        for (h = l.length > o.length ? l.length : o.length, a = 0; h > a; a++) e = o[a] = o[a] || this.dflt, i = l[a] = l[a] || this.dflt, p && (u = e.indexOf(p), f = i.indexOf(p), u !== f && (i = -1 === f ? l : o, i[a] += " " + p));e = o.join(", "), i = l.join(", ");
      }return _e(t, this.p, e, i, this.clrs, this.dflt, r, this.pr, s, n);
    }, l.parse = function (t, e, i, r, n, a) {                         //
      return this.parseComplex(t.style, this.format(H(t, this.p, s, !1, this.dflt)), this.format(e), n, a);
    }, a.registerSpecialProp = function (t, e, i) {                    //
      me(t, { parser: function (t, r, s, n, a, o) {                    // 98
      ...
      var r,                                                           // 98
          ...
          n = /([a-z])([A-Z])/g;for (r in babelHelpers.sanitizeForInObject(i)) s.setAttributeNS(null, r.replace(n, "$1-$2").toLowerCase(), i[r]);return (e.appendChild(s), s);
    },                                                                 //
      ...
      if (t._gsTransform && i && !r) return t._gsTransform;var n,      // 98
          o,                                                           //
          l,                                                           //
          h,                                                           //
          u,                                                           //
        ...
        for (o = (n || "").match(/(?:\-|\b)[\d\-\.e]+\b/gi) || [], l = o.length; --l > -1;) h = Number(o[l]), o[l] = (u = h - (h |= 0)) ? (0 | u * w + (0 > u ? -.5 : .5)) / w + h : h;if (16 === o.length) {
          var C = o[8],                                                // 98
              k = o[9],                                                //
              A = o[10],                                               //
              D = o[12],                                               //
        ...
        }y.zOrigin = S;for (l in babelHelpers.sanitizeForInObject(y)) T > y[l] && y[l] > -T && (y[l] = 0);
      ...
      var e,                                                           // 98
        ...
        i = l, l = -h, h = -i, e = p.filter, f.filter = "";var _,      // 98
            d,                                                         //
      ...
      var e,                                                           // 98
        ...
        if (r._transform) return n;var h,                              // 98
            u,                                                         //
            f,                                                         //
            p,                                                         //
            _,                                                         //
            ...
            y = ye.length,                                             //
            x = l,                                                     //
            T = {};if ("string" == typeof x.transform && xe) f = X.style, f[xe] = x.transform, f.display = "block", f.position = "absolute", z.body.appendChild(X), h = Ae(X, null, !1), z.body.removeChild(X);else if ("object" == typeof x) {
          if ((h = { scaleX: re(null != x.scaleX ? x.scaleX : x.scale, m.scaleX), scaleY: re(null != x.scaleY ? x.scaleY : x.scale, m.scaleY), scaleZ: re(x.scaleZ, m.scaleZ), x: re(x.x, m.x), y: re(x.y, m.y), z: re(x.z, m.z), xPercent: re(x.xPercent, m.xPercent), yPercent: re(x.yPercent, m.yPercent), perspective: re(x.transformPerspective, m.perspective) }, d = x.directionalRotation, null != d)) if ("object" == typeof d) for (f in babelHelpers.sanitizeForInObject(d)) x[f] = d[f];else x.rotation = d;"string" == typeof x.x && -1 !== x.x.indexOf("%") && (h.x = 0, h.xPercent = re(x.x, m.xPercent)), "string" == typeof x.y && -1 !== x.y.indexOf("%") && (h.y = 0, h.yPercent = re(x.y, m.yPercent)), h.rotation = se("rotation" in x ? x.rotation : "shortRotation" in x ? x.shortRotation + "_short" : "rotationZ" in x ? x.rotationZ : m.rotation, m.rotation, "rotation", T), be && (h.rotationX = se("rotationX" in x ? x.rotationX : "shortRotationX" in x ? x.shortRotationX + "_short" : m.rotationX || 0, m.rotationX, "rotationX", T), h.rotationY = se("rotationY" in x ? x.rotationY : "shortRotationY" in x ? x.shortRotationY + "_short" : m.rotationY || 0, m.rotationY, "rotationY", T)), h.skewX = null == x.skewX ? m.skewX : se(x.skewX, m.skewX), h.skewY = null == x.skewY ? m.skewY : se(x.skewY, m.skewY), (u = h.skewY - m.skewY) && (h.skewX += u, h.rotation += u);
        ...
        var o,                                                         // 98
          ...
          for (o = m.split(" "), l = g.split(" "), I.setAttribute("src", p), h = 2; --h > -1;) m = o[h], u = -1 !== m.indexOf("%"), u !== (-1 !== l[h].indexOf("%")) && (f = 0 === h ? t.offsetWidth - I.width : t.offsetHeight - I.height, o[h] = u ? parseFloat(m) / 100 * f + "px" : 100 * (parseFloat(m) / f) + "%");m = o.join(" ");
      ...
      var e,                                                           // 98
        ...
        var o = parseFloat(H(t, "opacity", s, !1, "1")),               // 98
            l = t.style,                                               //
      ...
      e && (t.removeProperty ? ("ms" === e.substr(0, 2) && (e = "M" + e.substr(1)), t.removeProperty(e.replace(P, "-$1").toLowerCase())) : t.removeAttribute(e));
        ...
        Xe = function (t) {                                            //
      if ((this.t._gsClassPT = this, 1 === t || 0 === t)) {            // 98
        this.t.setAttribute("class", 0 === t ? this.b : this.e);for (var e = this.data, i = this.t.style; e;) e.v ? i[e.p] = e.v : ze(i, e.p), e = e._next;1 === t && this.t._gsClassPT === this && (this.t._gsClassPT = null);
        ...
        var h,                                                         // 98
          ...
          for (p = {}, _ = f.data; _;) p[_.p] = 1, _ = _._next;f.setRatio(1);
      ...
      if ((1 === t || 0 === t) && this.data._totalTime === this.data._totalDuration && "isFromStart" !== this.data.data) {
        var e,                                                         // 98
            ...
            s,                                                         //
            n = this.t.style,                                          //
            a = o.transform.parse;if ("all" === this.e) n.cssText = "", s = !0;else for (e = this.e.split(" ").join("").split(","), r = e.length; --r > -1;) i = e[r], o[i] && (o[i].parse === a ? s = !0 : i = "transformOrigin" === i ? we : o[i].p), ze(n, i);s && (ze(n, xe), this.t._gsTransform && delete this.t._gsTransform);
      }                                                                //
    };for (me("clearProps", { parser: function (t, e, r, s, n) {       //
        return (n = new pe(t, r, 0, 0, n, 2), n.setRatio = Ie, n.e = e, n.pr = -10, n.data = s._tween, i = !0, n);
      } }), l = "bezier,throwProps,physicsProps,physics2D".split(","), ce = l.length; ce--;) ge(l[ce]);l = a.prototype, l._firstPT = null, l._onInitTween = function (t, e, o) {
      if (!t.nodeType) return !1;this._target = t, this._tween = o, this._vars = e, h = e.autoRound, i = !1, r = e.suffixMap || a.suffixMap, s = q(t, ""), n = this._overwriteProps;var l,
        ...
        for (x = 3 === this._transformType, xe ? f && (u = !0, "" === w.zIndex && (v = H(t, "zIndex", s), ("auto" === v || "" === v) && this._addLazySet(w, "zIndex", 0)), _ && this._addLazySet(w, "WebkitBackfaceVisibility", this._vars.WebkitBackfaceVisibility || (x ? "visible" : "hidden"))) : w.zoom = 1, c = p; c && c._next;) c = c._next;y = new pe(t, "transform", 0, 0, null, 2), this._linkCSSP(y, null, c), y.setRatio = x && be ? Me : xe ? Le : De, y.data = this._transform || Ae(t, s, !0), n.pop();
      }if (i) {                                                        //
        for (; p;) {                                                   // 98
          for (g = p._next, c = d; c && c.pr > p.pr;) c = c._next;(p._prev = c ? c._prev : m) ? p._prev._next = p : d = p, (p._next = c) ? c._prev = p : m = p, p = g;
        }this._firstPT = d;                                            //
      }return !0;                                                      //
      ...
      var a,                                                           // 98
          ...
          m,                                                           //
          g,                                                           //
          v = t.style;for (a in babelHelpers.sanitizeForInObject(e)) _ = e[a], l = o[a], l ? i = l.parse(t, _, a, this, i, n, e) : (p = H(t, a, s) + "", m = "string" == typeof _, "color" === a || "fill" === a || "stroke" === a || -1 !== a.indexOf("Color") || m && b.test(_) ? (m || (_ = oe(_), _ = (_.length > 3 ? "rgba(" : "rgb(") + _.join(",") + ")"), i = _e(v, a, p, _, !0, "transparent", i, 0, n)) : !m || -1 === _.indexOf(" ") && -1 === _.indexOf(",") ? (u = parseFloat(p), c = u || 0 === u ? p.substr((u + "").length) : "", ("" === p || "auto" === p) && ("width" === a || "height" === a ? (u = te(t, a, s), c = "px") : "left" === a || "top" === a ? (u = Q(t, a, s), c = "px") : (u = "opacity" !== a ? 0 : 1, c = "")), g = m && "=" === _.charAt(1), g ? (f = parseInt(_.charAt(0) + "1", 10), _ = _.substr(2), f *= parseFloat(_), d = _.replace(y, "")) : (f = parseFloat(_), d = m ? _.substr((f + "").length) || "" : ""), "" === d && (d = a in r ? r[a] : c), _ = f || 0 === f ? (g ? f + u : f) + d : e[a], c !== d && "" !== d && (f || 0 === f) && u && (u = G(t, a, u, c), "%" === d ? (u /= G(t, a, 100, "%") / 100, e.strictUnits !== !0 && (p = u + "%")) : "em" === d ? u /= G(t, a, 1, "em") : "px" !== d && (f = G(t, a, f, d), d = "px"), g && (f || 0 === f) && (_ = f + u + d)), g && (f += u), !u && 0 !== u || !f && 0 !== f ? void 0 !== v[a] && (_ || "NaN" != _ + "" && null != _) ? (i = new pe(v, a, f || u || 0, 0, i, -1, a, !1, 0, p, _), i.xs0 = "none" !== _ || "display" !== a && -1 === a.indexOf("Style") ? _ : p) : U("invalid " + a + " tween value: " + e[a]) : (i = new pe(v, a, u, f - u, i, 0, a, h !== !1 && ("px" === d || "zIndex" === a), 0, p, _), i.xs0 = d)) : i = _e(v, a, p, _, !0, null, i, 0, n)), n && i && !i.plugin && (i.plugin = n);
      return i;                                                        // 99
      ...
      var e,                                                           // 99
          ...
          r,                                                           //
          s = this._firstPT,                                           //
          n = 1e-6;if (1 !== t || this._tween._time !== this._tween._duration && 0 !== this._tween._time) if (t || this._tween._time !== this._tween._duration && 0 !== this._tween._time || this._tween._rawPrevTime === -1e-6) for (; s;) {
        ...
        } else -1 === s.type ? s.t[s.p] = s.xs0 : s.setRatio && s.setRatio(t);else s.t[s.p] = e + s.xs0;s = s._next;
      ...
      var i,                                                           // 99
        ...
        n = {};for (r in babelHelpers.sanitizeForInObject(e)) n[r] = e[r];n.opacity = 1, n.autoAlpha && (n.visibility = 1);
      }return (e.className && (i = this._classNamePT) && (s = i.xfirst, s && s._prev ? this._linkCSSP(s._prev, i._next, s._prev._prev) : s === this._firstPT && (this._firstPT = i._next), i._next && this._linkCSSP(i._next, i._next._next, s._prev), this._classNamePT = null), t.prototype._kill.call(this, n));
    };var Fe = function (t, e, i) {                                    //
      var r, s, n, a;if (t.slice) for (s = t.length; --s > -1;) Fe(t[s], e, i);else for (r = t.childNodes, s = r.length; --s > -1;) n = r[s], a = n.type, n.style && (e.push(Z(n)), i && i.push(n)), 1 !== a && 9 !== a && 11 !== a || !n.childNodes.length || Fe(n, e, i);
      ...
      var s,                                                           // 99
          ...
          u = [],                                                      //
          f = [],                                                      //
          p = e._internals.reservedProps;for (t = o._targets || o.target, Fe(t, h, f), o.render(i, !0), Fe(t, u), o.render(0, !0), o._enabled(!0), s = f.length; --s > -1;) if ((n = $(f[s], h[s], u[s]), n.firstMPT)) {
        n = n.difs;for (a in babelHelpers.sanitizeForInObject(r)) p[a] && (n[a] = r[a]);l.push(e.to(f[s], i, n));
      }return l;                                                       //
    }, t.activate([a]), a);                                            //
  }, !0);                                                              //
}), _gsScope._gsDefine && _gsScope._gsQueue.pop()(), (function (t) {   //
  "use strict";var e = function () {                                   // 99
    return (_gsScope.GreenSockGlobals || _gsScope)[t];                 // 99
  };"function" == typeof define && define.amd ? define(["TweenLite"], e) : "undefined" != typeof module && module.exports && (require("../TweenLite.js"), module.exports = e());
})("CSSPlugin");                                                       //
                                                                       //
/*!                                                                    //
...
var _gsScope = "undefined" != typeof module && module.exports && "undefined" != typeof global ? global : this || window;(function (t) {
  "use strict";var e = t.GreenSockGlobals || t,                        // 113
      i = function (t) {                                               //
    var i,                                                             // 113
        s = t.split("."),                                              //
    ...
    var e,                                                             // 113
        ...
        s,                                                             //
        r = [],                                                        //
        n = t.length;for (e = 0; n > e; e++) if ((i = t[e], l(i))) for (s = i.length, s = 0; i.length > s; s++) r.push(i[s]);else r.push(i);return r;
  },                                                                   //
      ...
      m = function (t) {                                               //
    t = t || "";var e = -1 !== t.indexOf("++"),                        // 113
        i = 1;return (e && (t = t.split("++").join("")), function () {
      return f + (t ? " class='" + t + (e ? i++ : "") + "'>" : ">");   // 113
    });                                                                //
  },                                                                   //
    ...
    var s = t.nodeType;if (1 === s || 9 === s || 11 === s) for (t = t.firstChild; t; t = t.nextSibling) g(t, e, i);else (3 === s || 4 === s) && (t.nodeValue = t.nodeValue.split(e).join(i));
      ...
      v = function (t, e) {                                            //
    for (var i = e.length; --i > -1;) t.push(e[i]);                    // 113
  },                                                                   //
    ...
    c.test(t.innerHTML) && (t.innerHTML = t.innerHTML.replace(c, u));var l,
        ...
        K = [],                                                        //
        J = [],                                                        //
        te = [];for (W && (H = H.split("++").join("")), Z && (R = R.split("<").join("{{LT}}")), l = R.length, f = V(), d = 0; l > d; d++) if ((T = R.charAt(d), ")" === T && R.substr(d, 20) === u)) f += ($ ? G : "") + "<BR/>", $ = !1, d !== l - 20 && R.substr(d + 20, 20) !== u && (f += " " + V(), $ = !0), d += 19;else if (" " === T && " " !== R.charAt(d - 1) && d !== l - 1 && R.substr(d - 20, 20) !== u) {
      for (f += $ ? G : "", $ = !1; " " === R.charAt(d + 1);) f += z, d++;(")" !== R.charAt(d + 1) || R.substr(d + 1, 20) !== u) && (f += z + V(), $ = !0);
    } else f += M && " " !== T ? Q() + T + "</div>" : T;for (t.innerHTML = f + ($ ? G : ""), Z && g(t, "{{LT}}", "<"), y = t.getElementsByTagName("*"), l = y.length, w = [], d = 0; l > d; d++) w[d] = y[d];if (O || L) for (d = 0; l > d; d++) b = w[d], p = b.parentNode === t, (p || L || M && !D) && (x = b.offsetTop, O && p && x !== I && "BR" !== b.nodeName && (_ = [], O.push(_), I = x), L && (b._x = b.offsetLeft, b._y = x, b._w = b.offsetWidth, b._h = b.offsetHeight), O && (D !== p && M || (_.push(b), b._x -= N), p && d && (w[d - 1]._wordEnd = !0), "BR" === b.nodeName && b.nextSibling && "BR" === b.nextSibling.nodeName && O.push([])));for (d = 0; l > d; d++) b = w[d], p = b.parentNode === t, "BR" !== b.nodeName ? (L && (S = b.style, D || p || (b._x += b.parentNode._x, b._y += b.parentNode._y), S.left = b._x + "px", S.top = b._y + "px", S.position = "absolute", S.display = "block", S.width = b._w + 1 + "px", S.height = b._h + "px"), D ? p && "" !== b.innerHTML ? J.push(b) : M && K.push(b) : p ? (t.removeChild(b), w.splice(d--, 1), l--) : !p && M && (x = !O && !L && b.nextSibling, t.appendChild(b), x || t.appendChild(n.createTextNode(" ")), K.push(b))) : O || L ? (t.removeChild(b), w.splice(d--, 1), l--) : D || t.appendChild(b);if (O) {
      for (L && (P = n.createElement("div"), t.appendChild(P), C = P.offsetWidth + "px", x = P.offsetParent === t ? 0 : t.offsetLeft, t.removeChild(P)), S = t.style.cssText, t.style.cssText = "display:none;"; t.firstChild;) t.removeChild(t.firstChild);for (k = !L || !D && !M, d = 0; O.length > d; d++) {
        for (_ = O[d], P = n.createElement("div"), P.style.cssText = "display:block;text-align:" + j + ";position:" + (L ? "absolute;" : "relative;"), H && (P.className = H + (W ? d + 1 : "")), te.push(P), l = _.length, y = 0; l > y; y++) "BR" !== _[y].nodeName && (b = _[y], P.appendChild(b), k && (b._wordEnd || D) && P.appendChild(n.createTextNode(" ")), L && (0 === y && (P.style.top = b._y + "px", P.style.left = N + x + "px"), b.style.top = "0px", x && (b.style.left = b._x - x + "px")));0 === l && (P.innerHTML = "&nbsp;"), D || M || (P.innerHTML = r(P).split(String.fromCharCode(160)).join(" ")), L && (P.style.width = C, P.style.height = b._h + "px"), t.appendChild(P);
      }t.style.cssText = S;                                            //
  ...
  "use strict";var e = function () {                                   // 113
    return (_gsScope.GreenSockGlobals || _gsScope)[t];                 // 113
  };"function" == typeof define && define.amd ? define(["TweenLite"], e) : "undefined" != typeof module && module.exports && (module.exports = e());
})("SplitText");                                                       //
                                                                       //
try {                                                                  // 116
  window.GreenSockGlobals = null;                                      // 117
  window._gsQueue = null;                                              // 118
  window._gsDefine = null;                                             // 119
                                                                       //
  delete window.GreenSockGlobals;                                      // 121
  delete window._gsQueue;                                              // 122
  delete window._gsDefine;                                             // 123
} catch (e) {}                                                         //
                                                                       //
try {                                                                  // 126
  window.GreenSockGlobals = oldgs;                                     // 127
  window._gsQueue = oldgs_queue;                                       // 128
} catch (e) {}                                                         //
                                                                       //
if (window.tplogs == true) try {                                       // 131
  console.groupEnd();                                                  // 133
} catch (e) {}                                                         //
                                                                       //
(function (e, t) {                                                     // 140
  e.waitForImages = { hasImageProperties: ["backgroundImage", "listStyleImage", "borderImage", "borderCornerImage"] };e.expr[":"].uncached = function (t) {
    ...
    if (e.isPlainObject(arguments[0])) {                               // 141
      n = t.each;r = t.waitForAll;t = t.finished;                      // 141
    }t = t || e.noop;n = n || e.noop;r = !!r;if (!e.isFunction(t) || !e.isFunction(n)) {
      throw new TypeError("An invalid callback was supplied.");        // 141
    }return this.each(function () {                                    //
      var i = e(this),                                                 // 141
          s = [];if (r) {                                              //
        var o = e.waitForImages.hasImageProperties || [],              // 141
            u = /url\((['"]?)(.*?)\1\)/g;i.find("*").each(function () {
          var t = e(this);if (t.is("img:uncached")) {                  // 141
            s.push({ src: t.attr("src"), element: t[0] });             // 141
          }e.each(o, function (e, n) {                                 //
            var r = t.css(n);if (!r) {                                 // 141
              return true;                                             // 141
            }var i;while (i = u.exec(r)) {                             //
              s.push({ src: i[2], element: t[0] });                    // 141
            }                                                          //
          });                                                          //
        });                                                            //
      } else {                                                         //
        i.find("img:uncached").each(function () {                      // 141
          s.push({ src: this.src, element: this });                    // 141
        });                                                            //
      }var f = s.length,                                               //
          l = 0;if (f == 0) {                                          //
        t.call(i[0]);                                                  // 141
      }e.each(s, function (r, s) {                                     //
        var o = new Image();e(o).bind("load error", function (e) {     // 141
          l++;n.call(s.element, l, f, e.type == "load");if (l == f) {  // 141
            t.call(i[0]);return false;                                 // 141
          }                                                            //
        });o.src = s.src;                                              //
      });                                                              //
    });                                                                //
